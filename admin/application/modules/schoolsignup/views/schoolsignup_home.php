...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage School Request</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>        
        <li class="active"><i class="icon-file-alt"></i>School Request</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">              
            <div class="pull-right" style="max-width: 603px;">
            <label class="inner-label">Search by School name Or Email Or Area name:</label>
...
function serachAdmin()
{
	...
	window.location='<?=base_url()?>schoolsignup/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>schoolsignup/delete" method="post">           
