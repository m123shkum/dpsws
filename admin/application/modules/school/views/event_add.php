    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'school/addevent/'.$school_id,array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"add_event","id"=>"add_event","onsubmit"=>"return valid_frm()")) ?>
