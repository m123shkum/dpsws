...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage School Jobs</small></h1>
       <ol class="breadcrumb">
        ...
        <li class="active"><i class="icon-file-alt"></i>Jobs</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">  
            <strong>"<?php echo $row['school_name']." , ".$row['state_name']?>"</strong>
          <div class="pull-right">
            <label class="inner-label">Search by job title:</label>
          ...
          <a style="text-decoration:none;" href="<?=base_url().'school/addjob/'.$school_id;?>"><span class="btn add-btn"></span></a>
      ...
      <tr <?php echo $class;?>>
        ...
        <td> 
         ...
         <?php } ?>
          ...
          <a rel="tooltip" alt="Update" href="<?=base_url()?>school/editjob/<?php echo $school_id?>/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
  ...
  <!--===================status changes form =====-->
    <form action="<?=base_url()?>school/changeJobStatus" method="post" id="cngststus">
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>school/jobs/<?php echo $school_id?>/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>school/jobs/<?php echo $school_id?>/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>school/searchjobs/<?php echo $school_id?>/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>school/deletejob" method="post">
           <input type="hidden" name="school_id" value="<?php echo $school_id?>">  
