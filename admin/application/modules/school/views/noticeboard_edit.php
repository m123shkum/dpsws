...
<div id="page-wrapper">
  ...
  <a style="text-decoration:none; float: right;" href="javascript:void(0)" onclick="javascript:history.go(-1)"><img src="<?=base_url()?>/public/images/back-btn.png" /></a>
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'school/updatenoticeboard/'.$school_id,array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"edit_noticeboard","id"=>"edit_noticeboard","onsubmit"=>"return valid_frm()")) ?>

            <input type="hidden" name="noticeboardForm" value='updateForm'>  
            <input type="hidden" name="school_id" value='<?php echo $school_id?>'>   
            <input type="hidden" name="noticeboard_id" value='<?php echo $results['id']?>'>             
            ...
            <div class="col-lg-6">                
                   ...
                   <div class="form-group">
                     ...
                     <textarea name="description" id="content"><?php echo $results['content']?></textarea> 
...
function valid_frm() { 
	...
	else
	{
		...
		document.getElementById("edit_noticeboard").submit();
	}
