    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'school/addmanagement/'.$school_id,array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"add_gallery","id"=>"add_gallery","onsubmit"=>"return valid_frm()")) ?>
            ...
            <div class="col-lg-6">                
                   <div class="form-group">
                     ...
                     <input class="form-control" type="text" name="management_name" id="image_title">
                     <div id="image_titleErr" style="color:#C33"></div>
                  </div>
                   <div class="form-group">
                     <label class="control-label">Designation*</label>
                     <input class="form-control" type="text" name="managemenat_designation" id="image_title">
                     <div id="image_titleErr" style="color:#C33"></div>
                  </div>
...
/*        if(image=='')
	...
	else
	{
		...
		document.getElementById("add_gallery").submit();
	}
