...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small> School Management Section</small> </h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>
        <li class="active"><a href="<?php echo base_url();?>school"><i class="icon-file-alt"></i>School</a></li>
        <li class="active"><i class="icon-file-alt"></i>Management</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">  
...
<a style="text-decoration:none;" href="<?=base_url().'school/addmanagement/'.$school_id;?>"><span class="btn add-btn"></span></a>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        <td><?php echo $j;?></td>
        <td><?php echo ucwords($data['management_name']);?></td>        
        <td>
        <?php  if($data['management_photo'])
		{ ?>
        <img src="<?php echo SiteUrl?>timthumb.php?src=<?php echo SiteUrl?>public/schoolimage/<?php echo $data['management_photo']?>&w=140&h=135" />
        <?php  }else {
		}
		?>
        </td>
        ...
        <td> 
         ...
         <?php } ?>
          ...
          <a rel="tooltip" alt="Update" href="<?=base_url()?>school/editmanagement/<?php echo $school_id ?>/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
...
<!--===================status changes form =====-->
    <form action="<?=base_url()?>school/changeStatus_gallery" method="post" id="cngststus">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>school/deletemanagement" method="post">
