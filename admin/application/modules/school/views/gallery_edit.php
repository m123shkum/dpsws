...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"><small>Manage School Gallery</small></h1>
      <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'school/updategallery/'.$school_id,array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"edit_gallery","id"=>"edit_gallery","onsubmit"=>"return valid_frm()")) ?>
            ...
            <div class="col-lg-6">                
                 ...
                 <img src="<?php echo SiteUrl?>timthumb.php?src=<?php echo SiteUrl?>public/schoolimage/<?php echo $results['image']?>&w=150&h=180" />
              </div> 
