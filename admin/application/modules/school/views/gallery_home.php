...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage School Gallery</small></h1>
       <ol class="breadcrumb">
      ...
      <div class="row-fluid">
        <div class="span6">  
          ...
          <a style="text-decoration:none;" href="<?=base_url().'school/addgallery/'.$school_id;?>"><span class="btn add-btn"></span></a>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td>
        <img src="<?php echo SiteUrl?>timthumb.php?src=<?php echo SiteUrl?>public/schoolimage/<?php echo $data['image']?>&w=140&h=135" />
        </td>
        ...
        <td> 
         ...
         <?php } ?>
          ...
          <a rel="tooltip" alt="Update" href="<?=base_url()?>school/editgallery/<?php echo $school_id?>/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
