...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Banner</small></h1>
       <ol class="breadcrumb">
      ...
      <div class="row-fluid">
        <div class="span6">              
          ...
          <a style="text-decoration:none;" href="<?=base_url().'banner/add'?>"><span class="btn add-btn"></span></a>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td><img height="200" width="200" src="<?=SiteUrl?>public/banner/<?php echo $data['image']?>"/></td>
        ...
        <td>  
         ...
         <?php } ?>
          <a rel="tooltip" alt="Update" href="<?=base_url()?>banner/edit/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
  ...
  <!--===================status changes form =====-->
    <form action="<?=base_url()?>banner/changeStatus" method="post" id="cngststus">
           <input type="hidden" name="uid"  id="uid" value="">
           <input type="hidden" name="statustype"  id="statustype" value="">
           <input type="hidden" name="curl"  id="curl" value="<?=base_url()?>banner">
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>banner/index/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>banner/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>banner/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>banner/delete" method="post">           
