...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Adventure</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>       
        <li class="active"><i class="icon-file-alt"></i>Adventure</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">              
          <div class="pull-right">
            <label class="inner-label">Search by Adventure Title or Area:</label>
          ...
          <a style="text-decoration:none;" href="<?=base_url().'adventure/add/'?>"><span class="btn add-btn"></span></a>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td><?php echo $data['adventure_area'];?></td>      
        <td> 
         ...
         <?php } ?>
          <a rel="tooltip" alt="Update" href="<?=base_url()?>adventure/edit/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
...
<!--===================status changes form =====-->
    <form action="<?=base_url()?>adventure/changeStatus" method="post" id="cngststus">
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>adventure/index/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>adventure/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>adventure/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>adventure/delete" method="post">           
