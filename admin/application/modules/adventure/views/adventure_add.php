    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'adventure/add',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"add_adventure","id"=>"add_adventure","onsubmit"=>"return valid_frm()")) ?>

            <input type="hidden" name="adventureForm" value='adventureForm'>  
            <div class="col-lg-6">                
...
function valid_frm() { 
	...
	else
	{
		...
		document.getElementById("add_adventure").submit();
	}
