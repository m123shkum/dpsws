    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">        
         <?php echo form_open(base_url().'location/update',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"editlocation","id"=>"editlocation","onsubmit"=>"return valid_frm()")) ?>

            <input type="hidden" name="locationForm" value='locationForm'>   
            <input type="hidden" name="zone_id" value='<?php echo $results['zone_id']?>'>   
             <?php 
                ...
                <div class="form-group">
                     ...
                     <select name="cityname" id="cityname" class="form-control" style="width:200px;">
                         ...
                         <?php foreach($state_results AS $state_result){
                             ...
                             ?>
                         <option <?php if($results['zone_locationid']==$city_result['zone_id']){?> selected <?php }?> value="<?php echo $city_result['zone_id']?>"><?php echo $city_result['cityname']?></option>
                         <?php }?>
                   ...
                   <div class="form-group">
                     ...
                     <input value="<?php echo $results['location']?>" class="form-control" type="text" name="location" id="location">                     
                  </div>               
...
function valid_frm() { 
	...
	else
	{
		...
		document.getElementById("editlocation").submit();
	}
