...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"><small>Manage Vendor Import</small></h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>
        <li class="active"><i class="icon-file-alt"></i>Vendor Import</li>        
      </ol>
    </div>
    <!-- /.col-lg-12 --> 
  </div>
  ...
  <a style="text-decoration:none;" href="<?=base_url()?>vendor"><img src="<?=base_url()?>/public/images/back-btn.png" /></a>
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'vendor/import_vendor/',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"import_vendor","id"=>"import_vendor","onsubmit"=>"return valid_frm()")) ?>
