...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Vendor Gallery</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>
        <li class="active"><a href="<?php echo base_url();?>vendor"><i class="icon-file-alt"></i>Vendor</a></li>
        <li class="active"><i class="icon-file-alt"></i>Gallery</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">              
          <div class="pull-right">
            <label class="inner-label">Search by Image title:</label>
          ...
          <a style="text-decoration:none;" href="<?=base_url().'vendor/addgallery/'.$vendor_id;?>"><span class="btn add-btn"></span></a>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td>
        <img src="<?php echo SiteUrl?>timthumb.php?src=<?php echo SiteUrl?>public/vendorimage/<?php echo $data['image']?>&w=140&h=135" />
        </td>       
        <td>      
         ...
         <?php } ?>
          <a rel="tooltip" alt="Update" href="<?=base_url()?>vendor/editgallery/<?php echo $vendor_id?>/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
  ...
  <div class="pagination-wrp">
    ...
    <!--===================status changes form =====-->
    <form action="<?=base_url()?>vendor/changeStatus_gallery" method="post" id="cngststus">
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>vendor/index/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>vendor/gallery/<?php echo $vendor_id?>/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>vendor/searchgallery/<?php echo $vendor_id?>/'+search_text;
	return false;
}
function getVal(id)
{    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>vendor/deletegallery" method="post">
