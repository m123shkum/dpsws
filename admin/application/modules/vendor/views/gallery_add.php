    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'vendor/addgallery/'.$vendor_id,array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"add_gallery","id"=>"add_gallery","onsubmit"=>"return valid_frm()")) ?>
