...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Vendor</small></h1>
       <ol class="breadcrumb">
      ...
      <div class="row-fluid">
        <div class="span6">         
            <div class="pull-right" style="max-width: 597px;">
            <label class="inner-label">Search by Vendor name Or Email Or Business:</label>
            ...
            <a style="float:right;background-color: #3a2556;" href="<?php echo site_url();?>vendor/export_vendor" class="btn sub-btn1"><strong>Export</strong></a> <a style="float:right;background-color: #3a2556;" class="btn sub-btn1" href="<?php echo site_url();?>vendor/import_vendor"><strong>Import</strong></a>
       <a style="text-decoration:none;" href="<?=base_url().'vendor/add';?>"><span class="btn add-btn"></span></a>
          <div class="sort-row">
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        <td><?php echo $k;?></td>
        <td><?php echo ucwords($data['vendor_name']);?></td>        
        <td><?php echo ucwords($data['business_name']);?></td>  
        <td><?php echo $data['emailid'];?></td> 
        <td><?php if($data['reg_date']!='0000-00-00'){echo date("d-M-Y",strtotime($data['reg_date']));}?></td>
        ...
        <td>                     
       <a style="background-color: #3a2556;" rel="tooltip" alt="Update" href="<?=base_url()?>vendor/gallery/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
            <i class="glyphicon">Gallery</i>
          </a>
            <a style="background-color: #3a2556;" rel="tooltip" alt="Update" href="<?=base_url()?>vendor/payment/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update"><i class="glyphicon"> Payment</i></a>
            &nbsp;&nbsp;&nbsp;
          </td>  
            <td>  
         ...
         <?php } ?>
          ...
          <a rel="tooltip" alt="Update" href="<?=base_url()?>vendor/edit/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
...
<!--===================status changes form =====-->
    <form action="<?=base_url()?>vendor/changeStatus" method="post" id="cngststus">
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>vendor/index/'+sort_by+'/'+val+'/0/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>vendor/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>vendor/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>vendor/delete" method="post">
