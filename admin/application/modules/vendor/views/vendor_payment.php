...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="icon-file-alt"></i>Payment</li>
      </ol>
    </div>
    <!-- /.col-lg-12 --> 
  </div>
  ...
  return round($diff / 86400);
         ...
         ?>
            ...
            <p><strong>Amount: </strong><?php echo $payment['amount']?> <strong>Start Date:</strong> <?php echo date("d-m-Y",strtotime($payment['start_date']))?> <strong>Expiry Date:</strong><?php echo date("d-m-Y",strtotime($payment['expiry_date']))?></p>
            <?php }?>
            
         <?php echo form_open(base_url().'vendor/action_payment',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"vendor_payment","id"=>"vendor_payment","onsubmit"=>"return valid_frm()")) ?>
...
function valid_frm() { 
	...
	else
	{
		...
		document.getElementById("vendor_payment").submit();
	}
