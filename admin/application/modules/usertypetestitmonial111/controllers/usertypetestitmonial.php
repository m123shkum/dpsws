...
class Usertypetestitmonial extends MX_Controller {
 public $droot = "";
  function __construct()
       {
           parent::__construct();
		   $this->load->model('UserTestimonial_model');
    ...
    {    
        ...
        if(!$this->session->userdata('userid'))
		{
			...
			$uid=$this->session->userdata('userid');			
					if(isset($_POST['testimonialForm'])) {                                           						
					      ...
					      $this->UserTestimonial_model->add_testimonial();	
	 ...
	 if(!$this->session->userdata('userid'))
		...
		else
		{
				...
				{
	                 $data['results']=$this->UserTestimonial_model->oneRecordById($page_id,"sch_usertype_testimonial");                         
		...
		if(!$this->session->userdata('userid'))
			{
		      redirect('user/login');
				 ...
				 $this->UserTestimonial_model->update_testimonial();	
