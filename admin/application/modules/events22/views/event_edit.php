            ...
            changeYear:true
                 ...
                 <div class="form-group">
                     ...
                     <select name="event_area" class="form-control" style="max-width:150px;">
                         <option <?php if($results['event_area']=='Delhi'){?> selected<?php }?> value="Delhi">Delhi</option>                         
                         <option <?php if($results['event_area']=='Faridabad'){?> selected<?php }?> value="Faridabad">Faridabad</option>
                         <option <?php if($results['event_area']=='Gurgaon'){?> selected<?php }?> value="Gurgaon">Gurgaon</option>
                          <option <?php if($results['event_area']=='Noida'){?> selected<?php }?> value="Noida">Noida</option>
                         <option <?php if($results['event_area']=='Ghaziabad'){?> selected<?php }?> value="Ghaziabad">Ghaziabad</option> 
                         <option <?php if($results['event_area']=='Greater Noida'){?> selected<?php }?> value="Greater Noida">Greater Noida</option> 
                     </select>                   
