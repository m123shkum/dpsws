...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage School Quick Alert</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>        
        <li class="active"><i class="icon-file-alt"></i>School Quick Alert</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">              
            <div class="pull-right" style="max-width: 580px;">
            <label class="inner-label">Search by School name Or Email Or Name:</label>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td><?php echo ucfirst($data['caf_email']);?></td>
        <td><?php echo $data['caf_contctno'];?></td>
        <td><?php echo $data['school1_name'];?><br><?php echo $data['school2_name'];?><br><?php echo $data['school3_name'];?></td>            
        <td><?php echo date("d M Y",strtotime($data['enquiry_date']));?></td>
        <td>                     
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>quickalert/index/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>quickalert/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>quickalert/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>quickalert/delete" method="post">           
