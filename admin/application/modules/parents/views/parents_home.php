...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Parents</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>
        <li class="active"><i class="icon-file-alt"></i>Parents</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">         
            <div class="pull-right" style="max-width: 572px;">
            <label class="inner-label">Search by Parent name or email or city:</label>
       ...
       <a style="text-decoration:none;" href="<?=base_url().'parents/add';?>"><span class="btn add-btn"></span></a>
          <div class="sort-row">
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td>                     
       <a style="background-color: #3a2556;" rel="tooltip" alt="Update" href="<?=base_url()?>parents/kids/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
            <i class="glyphicon">Kids</i>
          </a>&nbsp;&nbsp;&nbsp;
         ...
         <?php } ?>
          ...
          <a rel="tooltip" alt="Update" href="<?=base_url()?>parents/edit/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
...
<!--===================status changes form =====-->
    <form action="<?=base_url()?>parents/changeStatus" method="post" id="cngststus">
           <input type="hidden" name="uid"  id="uid" value="">
           <input type="hidden" name="statustype"  id="statustype" value="">
           <input type="hidden" name="curl"  id="curl" value="<?=base_url()?>parents/">
...
//var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>parents/index/name/'+val+'/0/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>parents/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>parents/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>parents/delete" method="post">
