...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Page</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>        
        <li class="active"><i class="icon-file-alt"></i>Page</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">              
          <div class="pull-right">
            <label class="inner-label">Search by Page title:</label>
          ...
          <a style="text-decoration:none;" href="<?=base_url().'page/add'?>"><span class="btn add-btn"></span></a>
  ...
  <div class="panel panel-default"> 
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        <td><?php echo $j;?></td>
        <td><?php echo ucfirst($data['page_title']);?></td>                
        ...
        <td>    
         ...
         <?php } ?>
          <a rel="tooltip" alt="Update" href="<?=base_url()?>page/edit/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
  ...
  <div class="pagination-wrp">
   ...
   <!--===================status changes form =====-->
    <form action="<?=base_url()?>page/changeStatus" method="post" id="cngststus">
           <input type="hidden" name="uid"  id="uid" value="">
           <input type="hidden" name="statustype"  id="statustype" value="">
           <input type="hidden" name="curl"  id="curl" value="<?=base_url()?>page">
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>page/index/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>page/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>page/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>page/delete" method="post">           
