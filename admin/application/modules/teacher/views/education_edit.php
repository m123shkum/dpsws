    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'teacher/updateeducation/'.$teacher_id,array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"edit_education","id"=>"edit_education","onsubmit"=>"return valid_frm()")) ?>

            <input type="hidden" name="educationForm" value='educationForm'>  
            <input type="hidden" name="teacher_id" value='<?php echo $teacher_id?>'>   
            <input type="hidden" name="edu_id" value='<?php echo $results['id']?>'>            
             
            <div class="col-lg-6">                
                   <div class="form-group">
                     <label class="control-label">Institution*</label>
                     <input value="<?php echo $results['institution']?>" class="form-control" type="text" name="institution" id="institution">                     
                  </div>                                                                      
                   <div class="form-group">
                     <label class="control-label">Board/University*</label>
                    <input value="<?php echo $results['board_university']?>" class="form-control" type="text" name="board_university" id="board_university">
                  </div>
                <div class="form-group">
                   ...
                   <? for($i=$st;$i<=$curyear;$i++){?>
                    <option <?php if($i==$results['year_passing']){?> selected <?php }?> value="<?=$i?>"><?=$i?></option>                    
                    <? }?>
                 ...
                 <div class="form-group">
                    ...
                    <input value="<?php echo $results['major_subject']?>" class="form-control" type="text" name="major_subject" id="major_subject">
                  </div>
                
                <div class="form-group">
                     <label class="control-label">Marks (% or CGPA)*</label>
                    <input value="<?php echo $results['marks']?>" class="form-control" type="text" name="marks" id="marks">
                  </div>
                ...
                <div class="form-group">
                    ...
                    <option value="">-- Select Qualification --</option>
                     <?php 
						 ...
						 ?>
                    <option <?php if($qualification['name']==$results['degree']){?> selected <?php }?> value="<?php echo $qualification['name']?>"><?php echo $qualification['name']?></option>
                     <?php }?>
                     </select>
                  </div>                     
...
function valid_frm() { 
	...
	else
	{
		...
		document.getElementById("edit_education").submit();
	}
