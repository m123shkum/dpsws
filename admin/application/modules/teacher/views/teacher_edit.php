    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'teacher/update',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"editteacher","id"=>"editteacher","onsubmit"=>"return valid_frm()")) ?>

            <input type="hidden" name="teacherUpdate" value='teacherUpdate'>  
            <input type="hidden" name="teacher_id" value='<?php echo $results['id']?>'> 
            <input type="hidden" name="userr_id" value='<?php echo $results['user_id']?>'> 
            <input type="hidden" name="hidden_resume" value='<?php echo $results['resume']?>'>  
            <div class="col-lg-6">                                                     
                   <div class="form-group">
                     <label class="control-label">Name*</label>
                     <input class="form-control" type="text" name="name" id="name" value="<?php echo $results['name']?>">
                     <div id="nameErr" style="color:#C33"></div>
                  </div>
                 <div class="form-group">
                     <label class="control-label">Email*</label>
                     <input class="form-control" readonly type="text" name="email" id="email" value="<?php echo $user_result['email']?>">                    
                  </div>
                ...
                <div class="form-group">
                     ...
                     <select class="form-control" name="teacher_category" id="teacher_category">
                         <option <?php if($results['teacher_category']=='teaching'){?> selected <?php }?> value="teaching">Teaching </option>
                         <option <?php if($results['teacher_category']=='nonteaching'){?> selected <?php }?> value="nonteaching">Non Teaching </option>
                     </select>
                   ...
                   <div class="form-group">
                     ...
                     <input class="form-control" type="text" name="mobileno" id="mobileno" onKeyPress="return isNumberKey(event)" maxlength="12" value="<?php echo $results['mobileno']?>">
                     <div id="mobilenoErr" style="color:#C33"></div>
                  </div>
                <div class="form-group">
                     <label class="control-label">Landline No.</label>
                     <input class="form-control" type="text" name="landline" id="landline" onKeyPress="return isNumberKey(event)" maxlength="12" value="<?php echo $results['landline']?>">                    
                  </div>
                ...
                <div class="form-group">
                     ...
                     <input class="form-control" type="text" name="pincode" id="pincode" value="<?php echo $results['pincode']?>">                     
                  </div>                
                        
                   <div class="form-group">
                     <label class="control-label">Resume Headline*</label>
                     <input class="form-control" type="text" name="resume_headline" id="resume_headline" value="<?php echo $results['resume_headline']?>">
                     <div id="resume_headlineErr" style="color:#C33"></div>
                  </div>  
                <div class="form-group">
                     <label class="control-label">Key Skills*</label>
                     <input class="form-control" type="text" name="keyskills" id="keyskills" value="<?php echo $results['keyskills']?>">
                ...
                <div class="form-group">
                   ...
                   <? for($i=1;$i<=30;$i++){?>
                    <option <?php if($results['exp_year']==$i){?> selected="selected" <?php }?> value="<?=$i?>"><?=$i?></option>                    
                    <? }?>                    
                    </select>&nbsp; &nbsp;
                    ...
                    <option value="0">Fresher</option>
                   <? for($i=1;$i<=12;$i++){?>
                    <option <?php if($results['exp_month']==$i){?> selected="selected" <?php }?> value="<?=$i?>"><?=$i?></option>                    
                    <? }?>                    
                        </select></span>
                  </div> 
                <div class="form-group">
                   ...
                   <? for($i=1;$i<=50;$i++){?>
                   <option <?php if($results['salaryinlac']==$i*100000){?> selected="selected" <?php }?> value="<?php echo $i*100000?>"><?php echo $i?></option>                  
                    <? }?>                    
                    </select>
            <select name="salinth" id="salinth" class="form-control" style="width:100px;">
				   ...
				   $i+=5;
				   ?>
                    <option <?php if($results['salaryinthousand']==$i*1000){?> selected="selected" <?php }?> value="<?php echo $i*1000?>"><?=$i?></option>                    
                    <? }?>                    
                    </select>  Per Anum
                  </div>
            ...
            <?php }?>
                   ...
                   <div class="form-group">
                     <label class="control-label">Resume (Doc,Xls,Pdf format only)</label>   
                     <?php if($results['resume']!=''){?>
                     <a href="<?=SiteUrl?>public/resume/<?php echo $results['resume'];?>">View Resume</a>
                     <?php }?>   
