...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Teacher Profession</small></h1>
       <ol class="breadcrumb">
        ...
        <li class="active"><i class="icon-file-alt"></i>Profession</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">   
          ...
          <a style="text-decoration:none;" href="<?=base_url().'teacher/addprofession/'.$teacher_id;?>"><span class="btn add-btn"></span></a>
    ...
    <table class="table">
      <tr <?php echo $class;?>>
        ...
        <td><strong>Organization</strong></td>
         ...
         <td><strong>Employment Period</strong></td> 
         <td></td>
      ...
      <tr <?php echo $class;?>>
        <td><?php echo $j;?></td>
        <td><?php echo ucfirst($data['organization']);?></td>        
        <td><?php echo ucfirst($data['designation']);?></td>
        <td><?php echo $data['duration_start_month']." ".$data['duration_start_year'] ?> to 
                        <?php 
					 if($data['duration_end_year']!=0)
					 {
					 echo $data['duration_end_month']." ".$data['duration_end_year'];
					 }else{echo "Till Date";}
                                         ?></td>
        <td>
          <a rel="tooltip" alt="Update" href="<?=base_url()?>teacher/editprofession/<?php echo $teacher_id?>/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>teacher/deleteprofession" method="post">
