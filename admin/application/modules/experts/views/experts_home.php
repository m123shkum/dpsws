...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1><small>Manage Experts Advise</small></h1>
       <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>user/home"><i class="icon-dashboard"></i> Dashboard</a></li>        
        <li class="active"><i class="icon-file-alt"></i>Experts Advise</li>
      </ol>
      <div class="row-fluid">
        <div class="span6">              
          <div class="pull-right">
            <label class="inner-label">Search by Name Or Email:</label>
...
var sort_by=document.getElementById("sort_by").value;
  ...
  window.location='<?=base_url()?>experts/index/'+sort_by+'/'+val+'/0'; 
}
function pageSort(sort_by) { 
	  window.location='<?=base_url()?>experts/index/'+sort_by+'/0/0';
}
function serachAdmin()
{
	...
	window.location='<?=base_url()?>experts/search/'+search_text;
	return false;
}
function getVal(id)
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?=base_url()?>experts/delete" method="post">           
