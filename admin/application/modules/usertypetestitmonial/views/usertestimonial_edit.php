...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"><small>Manage User Testimonial</small></h1>
      <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'usertypetestitmonial/update',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"testimonialfrm","id"=>"testimonialfrm","onsubmit"=>"return valid_frm()")) ?>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                     <label class="control-label">Author Name*</label>
                      <textarea class="form-control" name="description" id="content"><?php echo $results['description']?></textarea>
