    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
         ...
         <?php }
         ?>
         <?php echo form_open(base_url().'usertypetestitmonial/add',array("enctype"=>"multipart/form-data", "method"=>"post","name"=>"registerfrm","id"=>"registerfrm","onsubmit"=>"return valid_frm()")) ?>
