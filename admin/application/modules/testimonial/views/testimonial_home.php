    ...
    <div class="col-lg-12">
      ...
      <div class="row-fluid">
        <div class="span6">              
          ...
          <a style="text-decoration:none;" href="<?=base_url().'testimonial/add'?>"><span class="btn add-btn"></span></a>
    ...
    <table class="table">
      ...
      <tr <?php echo $class;?>>
        ...
        <td>    
         ...
         <?php } ?>
          <a rel="tooltip" alt="Update" href="<?=base_url()?>testimonial/edit/<?=$data['id']?>"  class="btn btn-xs btn-info" data-original-title="Update">
