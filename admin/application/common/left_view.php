      ...
      <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
          ...
          <li> <a <?php echo $classactive12?> href="<?php echo base_url();?>testimonial/"> Testimonials Management</a> </li>
           ...
           <li> <a <?php echo $classactive13?> href="<?php echo base_url();?>usertypetestitmonial/"> User Testimonials Management</a> </li>
<!--           <li> <a href="<?php echo base_url();?>adventure/"> Adventure Management</a> </li>-->
          <!--<li> <a href="<?php echo base_url();?>typepages/"> User Type</a> </li>   -->         
         <li> <a <?php echo $classactive14?> href="<?php echo base_url();?>typecontent/"> User Type Content</a> </li>        
         
          <li> <a <?php echo $classactive15?> href="<?php echo base_url();?>newsletter/">Subscriber Management</a> </li>
          <li> <a <?php echo $classactive16?> href="<?php echo base_url();?>advertise/">Advertise Management</a> </li>
          <li> <a <?php echo $classactive17?> href="<?php echo base_url();?>admission/">Admission Applied</a> </li>
<!--          <li> <a href="<?php echo base_url();?>caf/">Caf Applied</a> </li>-->
          <li> <a <?php echo $classactive18?> href="<?php echo base_url();?>location/">Location Management</a> </li>        
